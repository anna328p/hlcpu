        ...
        */
        ...
        if (Data_in_enable == 1'b1) begin                                   // Writing Data to Memory
            ...
            if (Dqm !== 4'b1111) begin
                ...
                if (Debug) begin
                    $display("%m : at time %t WRITE: Bank = %d Row = %d, Col = %d, Data = %d", $time, Bank, Row, Col, Dq_dqm[15:0]);
                end
            end else begin
                if (Debug) begin
            ...
            if (Dqm_reg0 !== 4'b1111) begin
                Dq_reg = #tAC Dq_dqm;
                if (Debug) begin
                    $display("%m : at time %t READ : Bank = %d Row = %d, Col = %d, Data = %d", $time, Bank, Row, Col, Dq_reg[15:0]);
                end
            end else begin
