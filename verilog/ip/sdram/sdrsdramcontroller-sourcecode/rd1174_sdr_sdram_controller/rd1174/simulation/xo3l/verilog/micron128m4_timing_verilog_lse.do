...
if {![file exists micron128m4_timing_verilog_lse]} {
    vlib micron128m4_timing_verilog_lse 
}
endif

design create micron128m4_timing_verilog_lse .
design open micron128m4_timing_verilog_lse
adel -all

cd $PROJ_DIR/xo3l/verilog

vlog -dbg ../micron128m4_xo3l_verilog_lse_vo.vo
...
vsim +access +r sdram_controller_tb -L ovi_machxo3l -noglitch +no_tchk_msg -sdfmax sdram_controller_tb_u1/sdram_controller_u1/sdram_controller_u1/ = "../micron128m4_xo3l_verilog_lse_vo.sdf"
