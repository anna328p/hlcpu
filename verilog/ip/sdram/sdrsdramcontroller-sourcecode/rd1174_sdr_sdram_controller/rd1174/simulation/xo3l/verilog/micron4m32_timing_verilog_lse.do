...
if {![file exists micron4m32_timing_verilog_lse]} {
    vlib micron4m32_timing_verilog_lse 
}
endif

design create micron4m32_timing_verilog_lse .
design open micron4m32_timing_verilog_lse
adel -all

cd $PROJ_DIR/xo3l/verilog

vlog -dbg ../micron4m32_xo3l_verilog_lse_vo.vo
...
##vsim +access +r sdram_controller_tb -PL pmi_work -L ovi_machxo3l -noglitch +no_tchk_msg -sdfmax sdram_controller_tb_u1 = "../micron4m32_xo3l_verilog_lse_vo.sdf"

vsim +access +r sdram_controller_tb -L ovi_machxo3l -noglitch +no_tchk_msg -sdfmax sdram_controller_tb_u1/sdram_controller_u1/sdram_controller_u1/ = "../micron4m32_xo3l_verilog_lse_vo.sdf"
