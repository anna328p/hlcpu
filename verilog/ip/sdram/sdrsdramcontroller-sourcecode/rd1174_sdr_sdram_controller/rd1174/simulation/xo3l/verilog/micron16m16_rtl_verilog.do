...
if {![file exists micron16m16_rtl_verilog]} {
    vlib micron16m16_rtl_verilog 
}
endif

design create micron16m16_rtl_verilog .
design open micron16m16_rtl_verilog
adel -all

cd $PROJ_DIR/xo3l/verilog/

vlog ../../../source/verilog/micron16m16/autorefresh_counter.v 	 
vlog ../../../source/verilog/micron16m16/delay_gen150us.v 
vlog ../../../source/verilog/micron16m16/lfsr_count255.v 
vlog ../../../source/verilog/micron16m16/lfsr_count64.v 
vlog ../../../source/verilog/micron16m16/sdram_control_fsm.v 
vlog ../../../source/verilog/micron16m16/sdram_controller.v

vlog ../../../testbench/verilog/micron16m16/mt48lc16m16a2.v 
vlog ../../../testbench/verilog/micron16m16/sdr_sdram_controller_wrapper.v	  
vlog ../../../testbench/verilog/micron16m16/sdr_sdram_controller_wrapper_synth.v  
vlog ../../../testbench/verilog/micron16m16/sdram_controller_tb.v
