...
if {![file exists micron16m8_rtl_verilog]} {
    vlib micron16m8_rtl_verilog 
}
endif

design create micron16m8_rtl_verilog .
design open micron16m8_rtl_verilog
adel -all

cd $PROJ_DIR/xo3l/verilog/

vlog ../../../source/verilog/micron16m8/autorefresh_counter.v 	 
vlog ../../../source/verilog/micron16m8/delay_gen150us.v 
vlog ../../../source/verilog/micron16m8/lfsr_count255.v 
vlog ../../../source/verilog/micron16m8/lfsr_count64.v 
vlog ../../../source/verilog/micron16m8/sdram_control_fsm.v 
vlog ../../../source/verilog/micron16m8/sdram_controller.v
