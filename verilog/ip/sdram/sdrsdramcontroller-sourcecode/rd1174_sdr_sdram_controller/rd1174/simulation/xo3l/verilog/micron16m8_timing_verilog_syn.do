...
if {![file exists micron16m8_timing_verilog_syn]} {
    vlib micron16m8_timing_verilog_syn 
}
endif

design create micron16m8_timing_verilog_syn .
design open micron16m8_timing_verilog_syn
adel -all

cd $PROJ_DIR/xo3l/verilog

vlog -dbg ../micron16m8_xo3l_verilog_syn_vo.vo
...
vsim +access +r sdram_controller_tb -L ovi_machxo3l -noglitch +no_tchk_msg -sdfmax sdram_controller_tb_u1/sdram_controller_u1/sdram_controller_u1/ = "../micron16m8_xo3l_verilog_syn_vo.sdf"
