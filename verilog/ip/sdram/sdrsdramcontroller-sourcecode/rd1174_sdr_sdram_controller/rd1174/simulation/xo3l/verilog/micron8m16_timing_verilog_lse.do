...
if {![file exists micron8m16_timing_verilog_lse]} {
    vlib micron8m16_timing_verilog_lse 
}
endif

design create micron8m16_timing_verilog_lse .
design open micron8m16_timing_verilog_lse
adel -all

cd $PROJ_DIR/xo3l/verilog

vlog -dbg ../micron8m16_xo3l_verilog_lse_vo.vo
...
vsim +access +r sdram_controller_tb -L ovi_machxo3l -noglitch +no_tchk_msg -sdfmax sdram_controller_tb_u1/sdram_controller_u1/sdram_controller_u1/ = "../micron8m16_xo3l_verilog_lse_vo.sdf"
