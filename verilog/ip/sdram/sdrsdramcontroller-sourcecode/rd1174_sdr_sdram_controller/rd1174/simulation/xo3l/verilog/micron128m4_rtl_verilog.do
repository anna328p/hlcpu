...
if {![file exists micron128m4_rtl_verilog]} {
    vlib micron128m4_rtl_verilog 
}
endif

design create micron128m4_rtl_verilog .
design open micron128m4_rtl_verilog
adel -all

cd $PROJ_DIR/xo3l/verilog/

vlog ../../../source/verilog/micron128m4/autorefresh_counter.v 	 
vlog ../../../source/verilog/micron128m4/delay_gen150us.v 
vlog ../../../source/verilog/micron128m4/lfsr_count255.v 
vlog ../../../source/verilog/micron128m4/lfsr_count64.v 
vlog ../../../source/verilog/micron128m4/sdram_control_fsm.v 
vlog ../../../source/verilog/micron128m4/sdram_controller.v

vlog ../../../testbench/verilog/micron128m4/mt48lc128m4a2.v 
vlog ../../../testbench/verilog/micron128m4/sdr_sdram_controller_wrapper.v	  
vlog ../../../testbench/verilog/micron128m4/sdr_sdram_controller_wrapper_synth.v  
vlog ../../../testbench/verilog/micron128m4/sdram_controller_tb.v
